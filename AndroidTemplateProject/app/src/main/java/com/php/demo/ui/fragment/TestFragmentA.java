...
import com.php.demo.widget.XCollapsingToolbarLayout;
 ...
 *    desc   : 项目炫酷效果示例
 */
public class TestFragmentA extends MyLazyFragment<HomeActivity>
    ...
    public void onScrimsStateChange(boolean shown) {
        if (shown) {
            ...
            mAddressView.setTextColor(getResources().getColor(R.color.widget_SettingBarBackgroundColor));
