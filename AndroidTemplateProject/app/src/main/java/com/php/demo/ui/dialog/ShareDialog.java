...
import com.php.base.BaseRecyclerViewAdapter;
...
//        }
    ...
    private static class ShareAdapter extends BaseRecyclerViewAdapter<ShareBean, ShareAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.mItemView.setText(bean.getShareName());
            Drawable drawable = bean.getShareIcon();
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
            holder.mItemView.setCompoundDrawables(null, drawable, null, null);
            holder.mItemView.setCompoundDrawablePadding((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics()));
        }
